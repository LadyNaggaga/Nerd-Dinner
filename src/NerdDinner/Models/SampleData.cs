    ...
    public static class SampleData
    {
        ...
        private static Dinner[] GetDinners()
        {
            var dinners = new Dinner[]
                ...
                new Dinner { Title = "Test Dinner Three", Address = "New York City, NY", ContactPhone = "425-XXX-XXXX", Country = "USA", Description = "Test Dinner Three", EventDate = DateTime.Now.AddDays(2), UserName = "user3@xxx.com", Latitude = 40.712784, Longitude = 74.005941 },
